...
Vector3D Math::Normal(Vector3D polygon[]){
...
Vector3D Math::ClosestPointOnLine(Vector3D a, Vector3D b, Vector3D point){
...
float Math::PlaneDistance(Vector3D normal, Vector3D point){
  //plane: Ax + By + Cz + D = 0
  //D = -(Ax + By + Cz)
...
bool Math::IntersectedPlane(Vector3D polygon[], Vector3D line[], Vector3D &normal, float &originDistance){
...
Vector3D Math::IntersectionPoint(Vector3D normal, Vector3D line[], double distance){
  Vector3D point;
...
bool Math::InsidePolygon(Vector3D intersection, Vector3D polygon[], long verticeCount){
...
bool Math::IntersectedPolygon(Vector3D polygon[], Vector3D line[], int vertexCount){
  Vector3D normal;
...
int Math::ClassifySphere(Vector3D &center, Vector3D &normal, Vector3D &point, float radius, float &distance){
...
bool Math::EdgeSphereCollision(Vector3D &center, Vector3D polygon[], int vertexCount, float radius){
...
bool Math::SpherePolygonCollision(Vector3D polygon[], Vector3D &center, int vertexCount, float radius){
...
Vector3D Math::GetCollisionOffset(Vector3D &normal, float radius, float distance){
