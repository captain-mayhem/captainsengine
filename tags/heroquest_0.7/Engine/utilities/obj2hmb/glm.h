...
typedef struct _GLMtriangle {
  GLint vindices[3];           /* array of triangle vertex indices */
  ...
  GLint material;
#endif
  //GLint neighbours[3];  /* array of indices for neighbouring triangles */
} GLMtriangle;
...
typedef struct _GLMgroup {
  ...
  GLint            numtriangles;   /* number of triangles in this group */
...
typedef struct _GLMmodel {
  ...
  GLint   numvertices;         /* number of vertices in model */
  GLfloat* vertices;            /* array of vertices  */

  GLint   numnormals;          /* number of normals in model */
  GLfloat* normals;             /* array of normals */

  GLint   numtexcoords;        /* number of texcoords in model */
  GLfloat* texcoords;           /* array of texture coordinates */

  GLint   numfacetnorms;       /* number of facetnorms in model */
  GLfloat* facetnorms;          /* array of facetnorms */

  GLint       numtriangles;    /* number of triangles in model */
  GLMtriangle* triangles;       /* array of triangles */

  GLint       nummaterials;    /* number of materials in model */
