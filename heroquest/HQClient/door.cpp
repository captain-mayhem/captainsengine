...
void Door::update(){
  ...
  //horizontal door
  if (pos_.x == pos2_.x){
    verts_[0] = Vector3D(pos_.x*QUADSIZE+THICKNESS, DOORHEIGHT, pos_.y*QUADSIZE+QUADSIZE-0.5*THICKNESS);
    verts_[1] = Vector3D(pos_.x*QUADSIZE+QUADSIZE-THICKNESS, DOORHEIGHT, pos_.y*QUADSIZE+QUADSIZE-0.5*THICKNESS);
    verts_[2] = Vector3D(pos_.x*QUADSIZE+THICKNESS, 0, pos_.y*QUADSIZE+QUADSIZE-0.5*THICKNESS);
    verts_[3] = Vector3D(pos_.x*QUADSIZE+QUADSIZE-THICKNESS, 0, pos_.y*QUADSIZE+QUADSIZE-0.5*THICKNESS);
    
    verts_[4] = Vector3D(pos_.x*QUADSIZE+QUADSIZE-THICKNESS, DOORHEIGHT, pos_.y*QUADSIZE+QUADSIZE+0.5*THICKNESS);
    verts_[5] = Vector3D(pos_.x*QUADSIZE+THICKNESS, DOORHEIGHT, pos_.y*QUADSIZE+QUADSIZE+0.5*THICKNESS);
    verts_[6] = Vector3D(pos_.x*QUADSIZE+QUADSIZE-THICKNESS, 0, pos_.y*QUADSIZE+QUADSIZE+0.5*THICKNESS);
    verts_[7] = Vector3D(pos_.x*QUADSIZE+THICKNESS, 0, pos_.y*QUADSIZE+QUADSIZE+0.5*THICKNESS);
  }
  //vertical door
  else{
    verts_[0] = Vector3D(pos_.x*QUADSIZE+QUADSIZE-0.5*THICKNESS, DOORHEIGHT, pos_.y*QUADSIZE+QUADSIZE-THICKNESS);
    verts_[1] = Vector3D(pos_.x*QUADSIZE+QUADSIZE-0.5*THICKNESS, DOORHEIGHT, pos_.y*QUADSIZE+THICKNESS);
    verts_[2] = Vector3D(pos_.x*QUADSIZE+QUADSIZE-0.5*THICKNESS, 0, pos_.y*QUADSIZE+QUADSIZE-THICKNESS);
    verts_[3] = Vector3D(pos_.x*QUADSIZE+QUADSIZE-0.5*THICKNESS, 0, pos_.y*QUADSIZE+THICKNESS);
    
    verts_[4] = Vector3D(pos_.x*QUADSIZE+QUADSIZE+0.5*THICKNESS, DOORHEIGHT, pos_.y*QUADSIZE+THICKNESS);
    verts_[5] = Vector3D(pos_.x*QUADSIZE+QUADSIZE+0.5*THICKNESS, DOORHEIGHT, pos_.y*QUADSIZE+QUADSIZE-THICKNESS);
    verts_[6] = Vector3D(pos_.x*QUADSIZE+QUADSIZE+0.5*THICKNESS, 0, pos_.y*QUADSIZE+THICKNESS);
    verts_[7] = Vector3D(pos_.x*QUADSIZE+QUADSIZE+0.5*THICKNESS, 0, pos_.y*QUADSIZE+QUADSIZE-THICKNESS);
  }
}
