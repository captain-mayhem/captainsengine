...
bool AdvMainTreeView::OnCreate(wxDocument* doc, long flags){
  mFrame = new wxDocMDIChildFrame(doc, this, wxGetApp().getFrame(), wxID_ANY,
    "Child frame", wxPoint(10,10), wxSize(300,300), wxDEFAULT_FRAME_STYLE | wxNO_FULL_REPAINT_ON_RESIZE);
  mFrame->Show(true);
  mGamepoolWindow = new wxMDIChildFrame(wxGetApp().getFrame(), wxID_ANY, "Gamepool", wxPoint(0,0), wxSize(200,200), wxSW_3D|wxCLIP_CHILDREN);
  mMediapoolWindow = new wxMDIChildFrame(wxGetApp().getFrame(), wxID_ANY, "Mediapool", wxPoint(0,200), wxSize(200,200), wxSW_3D|wxCLIP_CHILDREN);
