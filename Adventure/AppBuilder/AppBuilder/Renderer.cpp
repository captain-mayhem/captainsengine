...
void GL2Renderer::initShaders(){
  mShader.addShader(CGE::Shader::VERTEX_SHADER, vertexshadersource, sizeof(vertexshadersource) - 1);
  mShader.addShader(CGE::Shader::FRAGMENT_SHADER, fragmentshadersource, sizeof(fragmentshadersource)-1);
  mShader.linkShaders();
  mShader.activate();
