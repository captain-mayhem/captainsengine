...
#define FFMPEG_CONFIGURATION "--target-os=linux --arch=arm --disable-static --enable-shared --enable-version3 --enable-gpl --enable-nonfree --disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-encoders --disable-muxers --disable-devices --disable-protocols --enable-protocol=file --enable-avfilter --disable-network --disable-mpegaudio-hp --disable-avdevice --enable-cross-compile --cc=/media/data/android/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc --cross-prefix=arm-linux-androideabi- --nm=/media/data/android/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-nm --ar=/media/data/android/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-ar --extra-cflags=' -fPIC -DANDROID -I/media/data/android/android-ndk-r7c/platforms/android-8/arch-arm/usr/include' --disable-asm --enable-neon --enable-armv5te --extra-ldflags=' -Wl,-T,/media/data/android/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x -Wl,-rpath-link=/media/data/android/android-ndk-r7c/platforms/android-8/arch-arm/usr/lib -L /media/data/android/android-ndk-r7c/platforms/android-8/arch-arm/usr/lib -nostdlib /media/data/android/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/lib/gcc/arm-linux-androideabi/4.4.3/crtbegin.o /media/data/android/android-ndk-r7c/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/lib/gcc/arm-linux-androideabi/4.4.3/crtend.o -lc -lm -ldl '"
